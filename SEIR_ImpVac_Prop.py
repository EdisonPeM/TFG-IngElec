...
Description: The SEIR epidemic model with pulse vaccination in which the vaccination
             proportion (p) is directly proportional to the proportion of susceptible
             individuals (S).
"""
...
ax.plot(t, I, 'r', alpha=0.8, lw=0.9, label='Infecciosos')  
ax.plot(t, R, 'grey', alpha=0.6, lw=1.2, label='Recuperados')  
ax.plot(t, (pmin+k*S), 'black', alpha=0.6, lw=1.2, label='$p(S)$')  
